...
- La valutazione complessiva, da confermare tramite orale, terrà conto della qualità del progetto midterm (se svolto), della correttezza del progetto, e in aggiunta, dell'originalità e completezza delle primitive specifiche per il dominio, della visualizzazione del dominio e dei risultati, e della qualità degli esempi forniti.

## RELAZIONE CON IL MIDTERM

Gli studenti che hanno fatto il midterm possono sia estendere il progetto già iniziato, aggiungendo le funzionalità mancanti (funzioni, ifthenelse, while) e migliorando la visualizzazione del dominio e gli esempi finali, sia crearne uno nuovo. In questo caso, la consegna del progetto finale deve includere sia il codice del midterm che quello del progetto finale, ed una nuova relazione che sia completa, estesa, e includa anche una descrizione degli esempi presentati e della visualizzazione del dominio.
...
- il 12 gennaio 2026 per chi intende sostenere l'orale nel primo appello, altrimenti di regola 15 giorni prima dell'orale stesso da concordare a gruppi col docente.
